/*
    ...
    OpenGL loader generated by glad 0.1.35 on Sat Jul  2 13:17:25 2022.
...
struct gladGLversionStruct GLLoadedVersion = { 0, 0 };

int gladLoadGL(void) {

    return gladLoadGLVersion(0, 0);
}

int gladLoadGLVersion(int major, int minor) {

    GLLoadedVersion.major = major;
    GLLoadedVersion.minor = minor;
...
/* PR #18 */
    ...
    if(GLLoadedVersion.major > 0) {
        major = GLLoadedVersion.major; minor = GLLoadedVersion.minor;
    }
...
int gladLoadGLLoader(GLADloadproc load) {
    ...
    printf("Glad GL Version loaded %i.%i\n", GLLoadedVersion.major, GLLoadedVersion.minor);
